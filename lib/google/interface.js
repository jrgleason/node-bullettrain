...
exports.setLoginInfo= function(userIn,passIn){
  username = userIn
  password = passIn
}

exports.setAllInfo = function(userIn,passIn,appIn){
  username = userIn
  password = passIn
  appname = appIn
}
  ...
  console.log(itemData)
    ...
    var post_options = {
      ...
      headers: {
        ...
        'Authorization': 'GoogleLogin Auth='+getToken(username,password,appname)
      }
    }; 
...
exports.getToken = function(email, password, appname){
  var mainRes = res
  ...
  var post_req = https.request(post_options, function(res) {
    ...
    res.on('end', function() {
      ...
      authinfo = sid.substring(authLocation,sid.length-1);
      return next()
    })
  })
